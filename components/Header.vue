  ...
  <div class="relative w-full h-screen flex flex-col items-center justify-center">
    ...
    <div class="bg-[#25544A] w-full lg:w-1/2 h-screen flex flex-col items-center lg:items-start justify-end">
      <div class="absolute z-20 flex flex-col w-2/3 lg:w-1/4 top-0 mt-20 justify-center items-center lg:items-start">
        ...
        <a href="Footer" class="z-10 text-center flex items-center justify-between border-2 border-[#478957] text-[#69BE5C] font-bold text-xl tracking-[0.7rem] mt-10 px-4 pl-7 py-4 uppercase shadow-xl lg:rounded-r-full"><h1>kontakt</h1><img class="desktop-only w-16 ml-4 drop-shadow-lg" src="/public/img/logo_round_light.svg" alt=""></a>
      </div>
