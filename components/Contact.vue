<template>
  <section id="kontakt" class="w-full my-1">
    <div class="mx-auto px-4 lg:w-1/2 bg-gray-100 pb-20">
      <!-- Heading -->
      <h2
        class="flex h-full font-montserrat text-[var(--teal-dark)] text-4xl lg:text-6xl font-black tracking-[0.8rem] lg:tracking-[1.5rem] uppercase ml-10 lg:ml-20 pt-28">
        Kontakt
      </h2>
        ...
        <div class="flex-1 mx-10">
          <form @submit.prevent="handleSubmit" class="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <input type="text" id="name" v-model="name" required class="w-full border border-[var(--green-light)] rounded p-2
            ...
            <div>
              ...
              <input type="email" id="email" v-model="email" required class="w-full border border-[var(--green-light)] rounded p-2
                         focus:outline-none focus:ring-2
                         focus:ring-[var(--green-light)]" />
            </div>
            ...
            <div>
              ...
              <textarea id="message" v-model="message" required rows="4" class="w-full border border-[var(--green-light)] rounded p-2
                         focus:outline-none focus:ring-2
                         focus:ring-[var(--green-light)]"></textarea>
            </div>
            ...
            <div>
              ...
              <input id="attachments" type="file" accept="image/*" multiple @change="onFileChange" class="w-full text-sm text-gray-700
